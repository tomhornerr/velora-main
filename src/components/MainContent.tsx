  ...
  return <div className={`flex-1 relative ${className || ''}`}>
      ...
      <div className={`relative z-10 h-full flex flex-col ${
        isInChatMode 
          ? 'bg-transparent' 
          : currentView === 'upload' 
            ? 'bg-white/95 backdrop-blur-sm shadow-lg border-t border-r border-b border-white/30' 
            : 'bg-white/20 backdrop-blur-sm shadow-lg border-t border-r border-b border-white/30'
