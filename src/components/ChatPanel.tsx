...
export const ChatPanel = ({
  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className={`fixed left-32 lg:left-40 top-0 h-full w-80 bg-white/90 backdrop-blur-xl border-r border-slate-200/60 flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.08)] z-40 ${className || ''}`}
          >
            {/* Header */}
      ...
      {/* Bottom Undo Toast - Separate AnimatePresence */}
      <AnimatePresence>
        {showUndoToast && (
          <motion.div
            key="undo-toast"
      ...
      {/* Bottom Archive Toast - Separate AnimatePresence */}
      <AnimatePresence>
        {showArchiveToast && (
          <motion.div
            key="archive-toast"
