            ...
            `}>
              ...
              <div className="flex-1 relative">
                <input 
                  ...
                  className="w-full bg-transparent text-white placeholder:text-white/70 focus:outline-none text-base font-medium" 
                  autoComplete="off" 
              ...
              <div className="flex items-center space-x-3 ml-4">
                <button type="button" className="w-8 h-8 flex items-center justify-center text-white hover:text-white/80 hover:scale-110 active:scale-95 transition-all duration-200">
